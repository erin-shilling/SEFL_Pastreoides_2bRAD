...
cloneBams = read.csv("C:/Users/erin_/Documents/GitHub/SEFL_Pastreoides_2bRAD/denovo_mapped/data_files/poritesastreoidesMetaData.csv")
cloneMa = as.matrix(read.table("C:/Users/erin_/Documents/GitHub/SEFL_Pastreoides_2bRAD/denovo_mapped/data_files/pastClones.ibsMat"))
...
ggsave("C:/Users/erin_/Documents/GitHub/SEFL_Pastreoides_2bRAD/denovo_mapped/figures/cloneDend_nolabels_nobg.png", plot = cloneDend, height = 5, width = 16, units = "in", dpi = 300)
ggsave("C:/Users/erin_/Documents/GitHub/SEFL_Pastreoides_2bRAD/denovo_mapped/figures/cloneDend_nolabels.eps", plot = cloneDend, height = 5, width = 16, units = "in", dpi = 300)
...
pastVcf = read.vcfR("C:/Users/erin_/Documents/GitHub/SEFL_Pastreoides_2bRAD/denovo_mapped/data_files/pastNoClones.bcf", verbose = FALSE)
...
ggsave("C:/Users/erin_/Documents/GitHub/SEFL_Pastreoides_2bRAD/denovo_mapped/figures/fstHeatMap_pub.png", plot = snpHeatmap, width = 30, height = 9, units = "cm", dpi = 300)
#export with transparent background
ggsave("C:/Users/erin_/Documents/GitHub/SEFL_Pastreoides_2bRAD/denovo_mapped/figures/fstHeatMap_nocolor_nobg.png", plot = snpHeatmap, width = 30, height = 9, units = "cm", dpi = 300, bg = "transparent")
ggsave("C:/Users/erin_/Documents/GitHub/SEFL_Pastreoides_2bRAD/denovo_mapped/figures/fstHeatMap.eps", plot = snpHeatmap, width = 30, height = 9, units = "cm", dpi = 300)
```
...
popData = read.csv("C:/Users/erin_/Documents/GitHub/SEFL_Pastreoides_2bRAD/denovo_mapped/data_files/poritesastreoidesMetaData_clonesremoved.csv") %>% select("sample" = tube_id, "Population" = region)
...
hetAll = read.table("C:/Users/erin_/Documents/GitHub/SEFL_Pastreoides_2bRAD/denovo_mapped/data_files/hetAllSites")

colnames(hetAll) = c("sample", "All")
hetAll$sample = popData$sample

HetSNPs = read.table("C:/Users/erin_/Documents/GitHub/SEFL_Pastreoides_2bRAD/denovo_mapped/data_files/HetSNPs")
colnames(HetSNPs) = c("sample", "SNPs")
HetSNPs$sample = popData$sample

pastBreed = read.delim("C:/Users/erin_/Documents/GitHub/SEFL_Pastreoides_2bRAD/denovo_mapped/data_files/newres")
...
pastRelate = read.delim("C:/Users/erin_/Documents/GitHub/SEFL_Pastreoides_2bRAD/denovo_mapped/data_files/newres")
...
#![](C:/Users/erin_/Documents/GitHub/SEFL_Pastreoides_2bRAD/denovo_mapped/figures/heterozygosityPlot.png)

```{r, Analysis of Molecular Variance}
#packages: tidyverse, vcfR, adegenet, poppr
#reading in bcf file
pastVcf = read.vcfR("C:/Users/erin_/Documents/GitHub/SEFL_Pastreoides_2bRAD/denovo_mapped/data_files/pastNoClones.bcf", verbose = TRUE)
...
popData = read.csv("C:/Users/erin_/Documents/GitHub/SEFL_Pastreoides_2bRAD/denovo_mapped/data_files/poritesastreoidesMetaData_clonesremoved.csv") %>% select("sample" = tube_id, "pop" = region)
...
ggsave("C:/Users/erin_/Documents/GitHub/SEFL_Pastreoides_2bRAD/denovo_mapped/figures/envcorplot_redo.png", plot = EnvPlotCor, height = 15, width = 15, units = "in", dpi = 300)
...
ggsave("C:/Users/erin_/Documents/GitHub/SEFL_Pastreoides_2bRAD/denovo_mapped/figures/DbrdaPlot.png", plot = pastDbrdaPlot1, height = 3.5, width = 7, units = "in", dpi = 300)
#add bg = "transparent" to export with no background color
ggsave("C:/Users/erin_/Documents/GitHub/SEFL_Pastreoides_2bRAD/denovo_mapped/figures/DbrdaPlot.pdf", plot = pastDbrdaPlot1, height = 3.5, width = 7, units = "in", dpi = 300)
ggsave("C:/Users/erin_/Documents/GitHub/SEFL_Pastreoides_2bRAD/denovo_mapped/figures/DbrdaPlot.tiff", plot = pastDbrdaPlot1, height = 3.5, width = 7, units = "in", dpi = 300)
```
<br>
...
ggsave("C:/Users/erin_/Documents/GitHub/SEFL_Pastreoides_2bRAD/denovo_mapped/figures/admixturePlotK3.png", plot = admixPlotK3, width = 15, height = 5, units = "cm", dpi = 300)

#Figure for supplemental with both K = 3 & K = 7
kColPal7 = paletteer_d("LaCroixColoR::MurePepino")[c(1:7)]
...
admixPlotK <- ggarrange(admixPlotK3, admixPlotK7,
                    ncol = 1, nrow = 2)

admixPlotK

ggsave("C:/Users/erin_/Documents/GitHub/SEFL_Pastreoides_2bRAD/denovo_mapped/figures/admixturePlotK3+7.png", plot = admixPlotK, width = 15, height = 10, units = "cm", dpi = 300)
```
...
fileList = substr(list.files("C:/Users/erin_/Documents/GitHub/SEFL_Pastreoides_2bRAD/denovo_mapped/data_files/bayesAss/", "BA3trace.*.txt$"),1,10)
...
for(i in 1:length(fileList)){
  assign(fileList[i], read.delim(paste("C:/Users/erin_/Documents/GitHub/SEFL_Pastreoides_2bRAD/denovo_mapped/data_files/bayesAss/", fileList[i], ".txt", sep = ""))) %>% dplyr::select(-last_col())
...
```{r, BA3}
bayesAss = read.delim("C:/Users/erin_/Documents/GitHub/SEFL_Pastreoides_2bRAD/denovo_mapped/data_files/bayesAss/BA3trace07.txt") %>% filter(State > 2000000) %>% dplyr::select(-State, -LogProb, -X)
...
ggsave("C:/Users/erin_/Documents/GitHub/SEFL_Pastreoides_2bRAD/denovo_mapped/figures/migrate_nocolorpops.png", plot = migrate, width = 20, height = 8, units = "cm", dpi = 300)
ggsave("C:/Users/erin_/Documents/GitHub/SEFL_Pastreoides_2bRAD/denovo_mapped/figures/migrate.svg", plot = migrate, width = 20, height = 8, units = "cm", dpi = 300)

```
![](C:/Users/erin_/Documents/GitHub/SEFL_Pastreoides_2bRAD/denovo_mapped/figures/migrate.png)
...
ggsave("C:/Users/erin_/Documents/GitHub/SEFL_Pastreoides_2bRAD/denovo_mapped/figures/migrateMap_opaque.png", plot = migrateMap, width = 25.5, height = 15, units = "cm",dpi = 300)
#export with transparent background
...
ggsave("C:/Users/erin_/Documents/GitHub/SEFL_Pastreoides_2bRAD/denovo_mapped/figures/migrateMap.svg", plot = migrateMap, width = 25.5, height = 15, units = "cm",dpi = 300)

```

~~Subsequent analyses/figures were run but were not included in manuscript, either redundant or insignificant/not worth mentioning

Putting migration plots together into a single figure panel
```{r, migrationFigure}
...
#redundant with dbRDA and environmental factors
