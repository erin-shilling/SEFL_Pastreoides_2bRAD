...
#removed a lot of variables, want to see remaining ones that correlate more easily
...
corData = rcorr(as.matrix(envData3[,c(6:ncol(envData3))]), type = "pearson")
corDataFlat = melt(corData$r, value.name = "r")
pDataFlat = melt(corData$P, value.name = "p")
corDataBind = corDataFlat %>% left_join(pDataFlat, by = c("Var1","Var2"))
...
#removed variables that correlated more than 0.7 in excel, renamed
...
##Not sure if this is running correctly...
##am I even supposed to be running this?? commented out in Lexie's
