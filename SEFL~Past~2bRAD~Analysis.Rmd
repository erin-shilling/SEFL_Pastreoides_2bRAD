...
pastSamples = read.csv("C:/Users/erin_/Documents/GitHub/SEFL_Pastreoides_2bRAD/data_files/poritesastreoidesMetaData_clonesremoved.csv", header = TRUE) %>% select(sample = tube_id, !sample_id)
...
frt = read_sf("C:/Users/erin_/Documents/GitHub/SEFL_Pastreoides_2bRAD/data_files/shp/flReefs.shp") %>% st_transform(crs = 4326)
...
#ggsave("C:/Users/erin_/Documents/GitHub/SEFL_Pastreoides_2bRAD/figures/fstHeatMap_nocolor_nobg.png", plot = snpHeatmap, width = 30, height = 9, units = "cm", dpi = 300, bg = "transparent")
...
##haven't done this yet, not sure how to pick K
ADMIXTURE plot
...
ggsave("C:/Users/erin_/Documents/GitHub/SEFL_Pastreoides_2bRAD/genome_mapped/figures/admixturePlotK3+7.png", plot = admixPlotK, width = 15, height = 10, units = "cm", dpi = 300)
```
...
```
No outliers? Plot looks kinda of weird
