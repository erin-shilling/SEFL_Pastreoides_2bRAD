...
```{r, Figure 2, Dendrogram to identify clones}
...
ggsave("figures/fstHeatMap_GENOME_purple.png", plot = snpHeatmap, width = 30, height = 9, units = "cm", dpi = 300)
...
Heterozygosity & inbreeding calculations
```{r, popStats}
...
```{r, Figure 7, plots for depth, heterozygosity, & inbreeding}
...
ggsave("C:/Users/erin_/Documents/GitHub/SEFL_Pastreoides_2bRAD/figures/migrate_gray.png", plot = migrate, width = 20, height = 8, units = "cm", dpi = 300)
