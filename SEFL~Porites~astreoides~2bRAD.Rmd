...
siteMap = ggplot() +
  ...
  theme(panel.background = element_rect(fill = "aliceblue"),
        ...
        legend.text = element_text(size = 10), #was 8 before
...
cloneDendA = ggplot() +
  ...
  geom_text(data = subset(cloneDendPoints, subset = label %in% techReps), aes(x = (x + 0.09), y = (y - .003), label = "*"), angle = 90) + # spacing technical replicates further from leaf
...
ggsave("C:/Users/erin_/Documents/GitHub/SEFL_Pastreoides_2bRAD/figures/cloneDend_nolabels.png", plot = cloneDend, height = 7, width = 16, units = "in", dpi = 300)
ggsave("C:/Users/erin_/Documents/GitHub/SEFL_Pastreoides_2bRAD/figures/cloneDend_nolabels.eps", plot = cloneDend, height = 7, width = 16, units = "in", dpi = 300)
...
popAnno = data.frame(x1 = c(0.3, 0.3, 0.3, 0.3, 0.3), x2 = c(3.7, 10.7, 7.7, 10.7, 6.7),
                     ...
                     Region= c("St. Lucie", "Jupiter", "West Palm Beach", "Boynton Beach", "Ft. Lauderdale"))
